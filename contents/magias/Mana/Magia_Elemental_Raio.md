...
Como uma ação, desfira um ataque elétrico contra um inimigo.
...
- O ataque causa **dano dobrado contra Vida Temporária**.

---

### Campo Elétrico
Você descarrega eletricidade em área.
...
- **Falha:** Não pode utilizar **Reações** até o final do seu próximo turno.

---

### Redirecionar Magia
Sempre que acertar um alvo:

- Pode gastar **2 Magículas** para escolher um **segundo alvo**.
- Alcance do redirecionamento: **Mana (em metros)**.
- O segundo alvo recebe **metade do dano** da Magia.
...
- Requer **Livro de Formulação** ou ensino direto.
- Técnicas avançadas exigem técnicas básicas.
- Existem inúmeras formulações não oficiais a serem descobertas durante o RPG.

> Referência: https://trello.com/c/89NHq8vK
...
- Cria um **Foco de Mana de Raio**.
- Área máxima de criação: **igual à sua Mana**.
...
- **Ação:** Ataque em Área  
- **Área:** ponto escolhido dentro do alcance  
- Inimigos a **até 2m** realizam **Teste de Defesa (Destreza)** contra sua **CD Mágica**.
...
- Quando chegar a **0 de Vida**, pode consumir **30 Magículas**.
- Realize um **Teste de Mana (CD 20)**.

**Sucesso:**
- Retorna ao combate com **Vida Temporária = ER x 2**.
...
- Ele se torna **incapaz de curar Vida Temporária** até o final do próximo turno.
- Em **Crítico**, o alvo **perde toda a Vida Temporária**.
