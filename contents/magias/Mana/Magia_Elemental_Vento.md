...
### Levantar Objetos
Como Manipulação Livre, você pode mover objetos até o limite do seu **Peso Mágico**.

- Ao atingir um valor igual ao **seu próprio peso**, você se torna capaz de **voar**.
- **Deslocamento de Voo:** igual à sua **Mana**.

---

### Marca da Tontura
Sempre que causar dano com a Manipulação Livre:
...
- Técnicas avançadas exigem conhecimento das básicas.
- Existem inúmeras formulações não oficiais a serem descobertas durante o RPG.

> Referência: https://trello.com/c/wGhsFydU
...
- Recebe **+5m de Alcance** em Manipulação Livre.
...
- Escolha um alvo dentro do alcance da sua Manipulação Livre.
- O alvo recebe **Bônus de Deslocamento** igual à sua **Mana (em metros)**.
...
- Em **Crítico**, o alvo também fica **Tonto**.
...
- Focos de Rank igual ou superior:
  - Teste de Mana **CD = 10 + 5 por Rank do Foco**
...
- Cria um **Foco de Mana de Vento** ou **Foco de Mana Puro**
- Área máxima: **20m de você**
