...
> *“Nosso povo odeia estrangeiros. Vivemos em tribos espalhadas pelas Terras Sagradas de Ikshir. A força um dia nos ditou como superiores, mas aprendemos que a adaptabilidade é tudo. Metade réptil, metade gente — sem pertencer a nenhum dos dois — somos a raça mais orgulhosa da força.”*
> — **Samir, Ano 62**
...
* **Veneno**
  Seus ataques corpo a corpo causam **1d6 de dano adicional por turno**.
  O alvo pode gastar **1 ação padrão** para remover o veneno.

* **Asas**
  Pode **planar** uma distância igual à metade do deslocamento e ignora dano de queda.
  No **Rank 9**, pode voar metade do deslocamento.
  No **Rank 8**, pode voar igual ao deslocamento.

* **Pelos de Queratina**
  Pode se **grudar em paredes** e andar nelas com metade do deslocamento.
...
Além disso, role **um dado adicional** e escolha qual resistência manter.
