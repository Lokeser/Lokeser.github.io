...
Um conjurador pode, no início de um combate e antes de sua primeira ação, forjar um pacto temporário com a própria essência da magia. Ao aceitar limitações autoimpostas, conhecidas como **Restrições**, ele acumula **Pontos de Pacto (PP)**. Esses pontos podem ser gastos para adquirir **Benefícios** poderosos que duram até o fim do combate.

Pactos são manipulações de fórmulas que absorvem fórmulas do seu corpo mágico.

> **Regra de Aprendizado:** Você tem acesso automático às 5 primeiras Restrições e Benefícios Simples. Você precisa aprender todas as outras (Simples, Médias e Avançadas) por meio de Livros, Mestres ou criando suas próprias através de poderes de Profissão (ex: *Desenvolver Conhecimento*).

## Regras Gerais

* **Pontos de Pacto Máximos:** O número máximo de PP que você pode acumular é igual à sua **Mana + Sabedoria**.
* **Duração:** Tanto as Restrições quanto os Benefícios duram até o fim do combate atual.
* **Recuperação:** Seus Pontos de Pacto são um recurso conceitual que se "reinicia" após um **Interlúdio de Arco** (aproximadamente uma semana de tempo *in-game*). A decisão de usar um pacto é estratégica e de alto impacto.
* **Regra Fundamental:** Você não pode escolher uma Restrição que, sozinha, conceda mais PP do que o seu máximo de Pontos de Pacto permitido.

---

# Lista de Restrições
Estas são as limitações que você pode impor a si mesmo para ganhar Pontos de Pacto.

## Restrições Simples

* **Voto de Silêncio (1 PP):** Você não pode falar. Habilidades que requerem comando verbal falham automaticamente.
* **Passos Pesados (2 PP):** Seu deslocamento base é reduzido em 5 metros.
* **Alvo Declarado (2 PP):** No início de cada um de seus turnos, você deve declarar em voz alta qual inimigo será seu alvo principal. Você tem -1DR em ataques contra qualquer outro alvo.
* **Guarda Aberta (3 PP):** Você sofre uma penalidade de -3 em sua CA (Armadura de Combate).
* **Foco Singular (3 PP):** Você não pode realizar Ações Bônus.
* **Lapso de Memória (3 PP):** Escolha duas perícias. Você perde sua proficiência nelas, aplicando -1DR em testes com elas.
* **Magia Ruidosa (3 PP):** Todas as suas conjurações emitem um brilho e som intensos. Testes de Furtividade que envolvam magia falham automaticamente.
* **Voto de Gasto (4 PP):** Todas as suas habilidades, magias e poderes custam o dobro de Magículas para serem ativados.
* **Reflexos Sacrificados (4 PP):** Você não pode realizar Reações.
...
* **Fogo Indiscriminado (8 PP):** Suas magias de área que causam dano também afetam aliados dentro da área, sem distinção.
* **Pacto de Sangue (8 PP):** Você não pode ser curado por nenhuma fonte (habilidades, magias, poções) durante o combate.
* **Escudo Quebrado (9 PP):** Você não pode receber Pontos de Vida Temporários de nenhuma fonte.
* **Visão Turva (9 PP):** Você está permanentemente Ofuscado (-1DR em ataques e Percepção) e sua visão é limitada ao alcance Curto (6m).
* **Voto de Inércia (10 PP):** Seus ataques e habilidades não podem aplicar nenhuma Condição Adversa (ex: Tonto, Sangrando, Em Chamas).
* **Peso do Aço (5 PP):** Você não pode usar a Perícia *Esquiva*.
* **Fúria Mágica (7 PP):** Você só pode conjurar magias que causem dano direto. Magias de utilidade, buff ou controle estão bloqueadas.
* **Dreno Cinético (8 PP):** Toda vez que você erra um ataque físico, você perde 2 Magículas.
...
* **Trauma de Conversão (14 PP):** Toda vez que você sofre dano físico, você perde **2 Magículas**. Se chegar a 0 Magículas, você fica Atordoado por 1 rodada.
* **Sobrecarga Vital (16 PP):** Você não pode gastar Magículas. Em vez disso, todo custo de Magícula deve ser pago com **Pontos de Vida** (1 Magícula = 3 PVs).

---

# Lista de Benefícios
Estes são os poderes que você pode "comprar" com os Pontos de Pacto acumulados.
...
* **Condição Persistente (4 PP):** A CD para resistir a uma condição adversa aplicada por suas magias aumenta em 2.
* **Aura Protetora (4 PP):** Você recebe uma quantidade de Vida Temporária igual ao dobro da sua Eficiência de Rank no início do combate.
...
* **Vínculo Duradouro (5 PP):** A duração de suas magias que não causam dano instantâneo é duplicada.
* **Barreira Provisória (6 PP):** Escolha um tipo de dano mágico (ex: Fogo, Fé). Você ganha Resistência I contra esse dano.
* **Movimento Fluido (6 PP):** Seu deslocamento aumenta em 5 metros e você não provoca ataques de oportunidade ao se mover.
* **Explosão Arcana (7 PP):** Uma vez por combate, ao causar dano com uma magia, você pode adicionar um dado de dano extra do mesmo tipo (ex: 3d8 se torna 4d8).
* **Feitiço Inescapável (8 PP):** Uma vez por combate, você pode forçar um inimigo a realizar um Teste de Defesa contra sua magia com -1DR.
* **Magia Transmutada (8 PP):** Uma vez por combate, você pode mudar o tipo de dano de uma de suas magias para outro tipo de dano mágico (exceto Anômalo).
* **Celeridade Mágica (9 PP):** Uma vez por combate, você pode conjurar uma magia que normalmente custa uma Ação Padrão como uma Ação Bônus.
...
* **Fonte Infinita (12 PP):** Uma vez por combate, você pode conjurar uma magia sem gastar Magículas.
* **Realidade Desfeita (14 PP):** Uma vez por combate, você pode escolher maximizar os dados de dano de uma de suas magias, em vez de rolá-los.
* **Corrosão Mágica (15 PP):** Suas magias ignoram qualquer Resistência a Dano (mas não Imunidade).
* **Surto de Energia (16 PP):** Seu atributo de Mana aumenta em 1.
* **Surto de Sapiência (16 PP):** Seu atributo de Sabedoria aumenta em 1.
* **Imunidade Seletiva (17 PP):** Escolha um tipo de dano elemental (Fogo, Água, Terra, Vento, Raio). Você se torna Imune a ele.
* **Dobra Temporal (18 PP):** Uma vez por combate, você pode realizar uma Ação Padrão adicional em seu turno.
