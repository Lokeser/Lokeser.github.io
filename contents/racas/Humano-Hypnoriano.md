...
* **Vida Base:** **30 + 7 a cada 2 pontos de Constituição**
...
* Ao utilizar **Conectar Núcleo de Mana** em um alvo, pode, como **ação bônus no mesmo turno**, forçá-lo a realizar um **teste de Constituição** contra sua **CD Mágica**.
